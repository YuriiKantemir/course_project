...
public class Config {
    ...
    static final public Param HTTP_BASE_PATH    = new Param("http.base.page",   "jsonrpc.php",      true);
    static final public Param API_USER_NAME    = new Param("api.username",   "jsonrpc",      true);
    static final public Param API_USER_TOKEN    = new Param("api.token",   null,      true);
